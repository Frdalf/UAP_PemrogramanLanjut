...
public class DonationRepository {
    ...
    public DonationRepository(String filePath) {
    ...
    private void ensureFileExists() {
        try {
            ...
            if (Files.notExists(filePath)) {
                ...
                Files.writeString(filePath, "donasiId,tanggal,donorId,jenis,kategori,nominal,namaBarang,jumlahBarang,catatan\n");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal menyiapkan donation.csv:\n" + e.getMessage(),
    ...
    public List<Donation> loadAll() {
        ...
        try (BufferedReader br = Files.newBufferedReader(filePath)) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                list.add(new Donation(id, tgl, donorId, jenis, kategori, nominal, namaBarang, jumlahBarang, catatan));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal membaca donation.csv:\n" + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
        return list;
    }
    ...
    public void saveAll(List<Donation> donations) {
        try (BufferedWriter bw = Files.newBufferedWriter(filePath)) {
            ...
            JOptionPane.showMessageDialog(null, "Gagal menyimpan donation.csv:\n" + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}
